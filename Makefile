...
symlinks += $(makefile_dir)/mise/config.toml $(dest)/.config/mise/config.toml
symlinks += $(makefile_dir)/mise/mise.lock $(dest)/.config/mise/mise.lock
