...
symlinks += $(makefile_dir)/git/hooks/gitleaks-pre-commit.sh $(dest)/.config/git/hooks/gitleaks-pre-commit.sh
symlinks += $(makefile_dir)/git/hooks/gitleaks-pre-push.sh $(dest)/.config/git/hooks/gitleaks-pre-push.sh
