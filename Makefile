...
dotfile_dirs += $(dest)/.config/nekomata
...
symlinks += $(makefile_dir)/bash/.bashrc.d $(dest)/.bashrc.d
...
symlinks += $(makefile_dir)/git/hooks/pre-commit-gitleaks.sh $(dest)/.config/git/hooks/pre-commit-gitleaks.sh
symlinks += $(makefile_dir)/git/hooks/pre-push-gitleaks.sh $(dest)/.config/git/hooks/pre-push-gitleaks.sh
